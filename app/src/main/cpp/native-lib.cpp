...
Java_com_example_myapplication_SerialPort_open(JNIEnv *env, jclass type, jstring path_, jint baudrate,
                                           jint flags) {
...
Java_com_example_myapplication_SerialPort_close(JNIEnv *env, jobject instance) {
